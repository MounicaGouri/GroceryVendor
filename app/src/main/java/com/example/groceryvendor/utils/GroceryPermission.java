package com.example.groceryvendor.utils;
...
public class GroceryPermission {
    Activity context;

    private GroceryPermission(Activity context) {
        this.context = context;
    }

    public static GroceryPermission getInstance(Activity context) {
        GroceryPermission com = new GroceryPermission(context);
        return com;
    }
